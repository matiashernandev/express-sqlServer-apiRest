        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", res.status(400).json({
              msg: "Bad Resquest. TODO MAL"
            }));

          case 4:
            _context2.prev = 4;
            if (quantity == null) quantity = 0; //console.log(name, description, quantity);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 7:
            ...
            res.sendStatus(204); // res.send(result); //devuelve la BD
